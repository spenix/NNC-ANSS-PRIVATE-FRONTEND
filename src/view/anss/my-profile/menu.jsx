    ...
    <Col flex="240px" className="hp-profile-menu hp-py-24">
      <div className="hp-w-100">
        <div className="hp-profile-menu-header hp-mt-md-16 hp-text-center">
          ...
          <Badge>
            {/* <Avatar size={80} shape="circle" src={countryDetail.length ? countryDetail[0]?.flags?.svg : "" } /> */}
            <img src={countryDetail.length ? countryDetail[0]?.flags?.svg : "" } alt="Profile Image" width="50%" he="50%"/>
          </Badge>

          <h3 className="hp-mt-24 hp-mb-4">{myprofile?.first_name} {myprofile?.last_name}</h3>
          <a href="mailto:" className="hp-p1-body hp-mx-8">
            {myprofile?.email}
          </a>
        </div>
        ...
        >
          ...
          >
            <Link to="/my-profile/personel-information">
              Profile Information
            </Link>
          </Menu.Item>
          ...
          <Menu.Item
            ...
            onClick={props.onCloseDrawer}
          >
            <Link to="/my-profile/password-change">Change Password</Link>
          </Menu.Item>
